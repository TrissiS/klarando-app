...
export default function AdminDisplayDevicesError({ error, reset }: Props) {
  return (
    <div className="mx-auto mt-10 max-w-2xl rounded-2xl border border-red-200 bg-red-50 p-6 text-red-800">
      <h1 className="text-xl font-semibold">Display-Seite konnte nicht geladen werden</h1>
      <p className="mt-2 text-sm">
        Der Bildschirm wurde nicht gefunden oder konnte nicht geladen werden.
      </p>
