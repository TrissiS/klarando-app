...
export default function AdminScreenError({ error, reset }: Props) {
  return (
    <div className="mx-auto mt-10 max-w-2xl rounded-2xl border border-red-200 bg-red-50 p-6 text-red-800">
      <h1 className="text-xl font-semibold">Bildschirm wurde nicht gefunden</h1>
      <p className="mt-2 text-sm">
        Die Display-Konfiguration konnte nicht geladen werden. Bitte zurück zur Übersicht gehen.
      </p>
