...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 5
    iput-boolean v0, p0, Landroidx/constraintlayout/utils/widget/MockView;->k:Z
    ...
    iput-object v1, p0, Landroidx/constraintlayout/utils/widget/MockView;->n:Landroid/graphics/Rect;
    ...
    iput v1, p0, Landroidx/constraintlayout/utils/widget/MockView;->q:I

    const/4 v1, 0x4

    .line 12
    iput v1, p0, Landroidx/constraintlayout/utils/widget/MockView;->r:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/constraintlayout/utils/widget/MockView;->n:Landroid/graphics/Rect;
    ...
    iput v0, p0, Landroidx/constraintlayout/utils/widget/MockView;->q:I

    const/4 v0, 0x4

    .line 25
    iput v0, p0, Landroidx/constraintlayout/utils/widget/MockView;->r:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 31
    iput-boolean p3, p0, Landroidx/constraintlayout/utils/widget/MockView;->k:Z
    ...
    iput-object p3, p0, Landroidx/constraintlayout/utils/widget/MockView;->n:Landroid/graphics/Rect;
    ...
    iput p3, p0, Landroidx/constraintlayout/utils/widget/MockView;->q:I

    const/4 p3, 0x4

    .line 38
    iput p3, p0, Landroidx/constraintlayout/utils/widget/MockView;->r:I
...
.method public final a(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    sget-object v0, Lb/f/c/f;->MockView:[I
    ...
    .line 4
    sget v3, Lb/f/c/f;->MockView_mock_label:I
    ...
    .line 6
    :cond_1e
    sget v3, Lb/f/c/f;->MockView_mock_showDiagonals:I

    if-ne v2, v3, :cond_2b

    .line 7
    iget-boolean v3, p0, Landroidx/constraintlayout/utils/widget/MockView;->k:Z

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Landroidx/constraintlayout/utils/widget/MockView;->k:Z

    goto :goto_5e

    .line 8
    :cond_2b
    sget v3, Lb/f/c/f;->MockView_mock_diagonalsColor:I
    ...
    .line 10
    :cond_38
    sget v3, Lb/f/c/f;->MockView_mock_labelBackgroundColor:I

    if-ne v2, v3, :cond_45

    .line 11
    iget v3, p0, Landroidx/constraintlayout/utils/widget/MockView;->q:I

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v2

    iput v2, p0, Landroidx/constraintlayout/utils/widget/MockView;->q:I

    goto :goto_5e

    .line 12
    :cond_45
    sget v3, Lb/f/c/f;->MockView_mock_labelColor:I

    if-ne v2, v3, :cond_52

    .line 13
    iget v3, p0, Landroidx/constraintlayout/utils/widget/MockView;->p:I

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v2

    iput v2, p0, Landroidx/constraintlayout/utils/widget/MockView;->p:I

    goto :goto_5e

    .line 14
    :cond_52
    sget v3, Lb/f/c/f;->MockView_mock_showLabel:I
    ...
    iget v0, p0, Landroidx/constraintlayout/utils/widget/MockView;->p:I
    ...
    iget p2, p0, Landroidx/constraintlayout/utils/widget/MockView;->q:I

    invoke-virtual {p1, p2}, Landroid/graphics/Paint;->setColor(I)V

    .line 23
    iget p1, p0, Landroidx/constraintlayout/utils/widget/MockView;->r:I
    ...
    iput p1, p0, Landroidx/constraintlayout/utils/widget/MockView;->r:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 4
    iget-boolean v2, p0, Landroidx/constraintlayout/utils/widget/MockView;->k:Z
    ...
    .line 5
    iget-object v7, p0, Landroidx/constraintlayout/utils/widget/MockView;->h:Landroid/graphics/Paint;
    ...
    .line 6
    iget-object v10, p0, Landroidx/constraintlayout/utils/widget/MockView;->h:Landroid/graphics/Paint;
    ...
    .line 12
    iget-object v3, p0, Landroidx/constraintlayout/utils/widget/MockView;->i:Landroid/graphics/Paint;
    ...
    iget-object v6, p0, Landroidx/constraintlayout/utils/widget/MockView;->n:Landroid/graphics/Rect;

    invoke-virtual {v3, v2, v4, v5, v6}, Landroid/graphics/Paint;->getTextBounds(Ljava/lang/String;IILandroid/graphics/Rect;)V

    .line 13
    iget-object v2, p0, Landroidx/constraintlayout/utils/widget/MockView;->n:Landroid/graphics/Rect;
    ...
    .line 14
    iget-object v3, p0, Landroidx/constraintlayout/utils/widget/MockView;->n:Landroid/graphics/Rect;
    ...
    iget v4, p0, Landroidx/constraintlayout/utils/widget/MockView;->r:I
