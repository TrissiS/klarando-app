...
$shortcutPath = Join-Path $desktopPath "Klarando Mobile Test.lnk"
$powershellPath = "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe"
$iconPath = Join-Path $projectRoot "app\favicon.ico"

if (-not (Test-Path $startScript)) {
  Write-Host "Start-Skript nicht gefunden: $startScript" -ForegroundColor Red
  exit 1
}
...
$shortcut.Description = "Startet Klarando fuer Smartphone-Test im WLAN (Backend + Kunden-, Fahrer- und Klarando OrderDesk)"
